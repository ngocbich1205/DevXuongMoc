...
namespace DevXuongMoc.Areas.CustomerUser.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CustomerId,Name,Username,Password,Address,Email,Phone,Avatar,CreatedDate,UpdatedDate,CreatedBy,UpdatedBy,Isdelete,Isactive")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
